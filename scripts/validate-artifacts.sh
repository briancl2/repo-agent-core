...
# SOURCE_INSIGHT_PACKET.json, HERMES_FOREGROUND_RUN_RECEIPT.json,
# HERMES_FOREGROUND_FAILURE_GUIDANCE.json,
# HERMES_FOREGROUND_REPO_STAR_PILOT_RELIABILITY_RECEIPT.json,
# GBRAIN_ADVISORY_PILOT_OUTCOME_LEARNING_LOOP_RECEIPT.json,
# REPO_STAR_GENERICITY_PROOF_RECEIPT.json,
# REPO_STAR_DOWNSTREAM_GENERICITY_PROOF_RECEIPT.json
...
if [ -z "$SCHEMA_NAME" ]; then
  ...
  case "$BASENAME" in
    ...
    HERMES_FOREGROUND_RUN_RECEIPT|HERMES_FOREGROUND_RUN_RECEIPT_*) SCHEMA_NAME="HERMES_FOREGROUND_RUN_RECEIPT" ;;
    HERMES_FOREGROUND_FAILURE_GUIDANCE) SCHEMA_NAME="HERMES_FOREGROUND_FAILURE_GUIDANCE" ;;
    HERMES_FOREGROUND_REPO_STAR_PILOT_RELIABILITY_RECEIPT) SCHEMA_NAME="HERMES_FOREGROUND_REPO_STAR_PILOT_RELIABILITY_RECEIPT" ;;
    GBRAIN_ADVISORY_PILOT_OUTCOME_LEARNING_LOOP_RECEIPT) SCHEMA_NAME="GBRAIN_ADVISORY_PILOT_OUTCOME_LEARNING_LOOP_RECEIPT" ;;
    REPO_STAR_GENERICITY_PROOF_RECEIPT) SCHEMA_NAME="REPO_STAR_GENERICITY_PROOF_RECEIPT" ;;
    REPO_STAR_DOWNSTREAM_GENERICITY_PROOF_RECEIPT) SCHEMA_NAME="REPO_STAR_DOWNSTREAM_GENERICITY_PROOF_RECEIPT" ;;
    FINDINGS|findings) SCHEMA_NAME="FINDINGS" ;;
    *)
      echo "ERROR: Cannot auto-detect schema for '$BASENAME'. Specify schema name."
      echo "Available: SCORECARD, OPPORTUNITIES, OPTIMIZATION_SCORECARD, COMMAND_OUTPUT_ROI_RECEIPT, FINDINGS, TOKEN_MEASUREMENT_SUMMARY, HOTSPOT_EVIDENCE_PACKETS, AGENTIC_ROOT_CAUSE_BRIEFS, TRANSFER_ORACLE_RECEIPT, CRITIQUE_RESULT, PLAYBOOK_MANIFEST_AUTHORITY, ADAPTER_AUDIT_SUMMARY, SOURCE_INSIGHT_PACKET, HERMES_FOREGROUND_RUN_RECEIPT, HERMES_FOREGROUND_FAILURE_GUIDANCE, HERMES_FOREGROUND_REPO_STAR_PILOT_RELIABILITY_RECEIPT, GBRAIN_ADVISORY_PILOT_OUTCOME_LEARNING_LOOP_RECEIPT, REPO_STAR_GENERICITY_PROOF_RECEIPT, REPO_STAR_DOWNSTREAM_GENERICITY_PROOF_RECEIPT"
      exit 1
      ;;
  esac
fi
